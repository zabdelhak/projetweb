...
session_start();
 ...
 {   include("condb.php");
     ...
     if($rows!=0)
     {
      ...
      header("location: http://127.0.0.1:81/projetweb/pagep.php");
     }
     else
     {
      //header("location: http://127.0.0.1:81/projetweb/login.php?er=1");
     }
   }
   else
   {
      //header("location: http://127.0.0.1:81/projetweb/login.php?ep=1");
   }
}
?>